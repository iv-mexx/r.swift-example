...
struct R {
  ...
  struct image {
    static var icon256: UIImage? { return UIImage(named: "icon256") }
  }
  
  struct nib {
    static var customView: _R.nib._CustomView { return _R.nib._CustomView() }
  }
...
struct _R {
  struct nib {
    struct _CustomView: NibResource {
      var instance: UINib { return UINib.init(nibName: "CustomView", bundle: nil) }
      var name: String { return "CustomView" }
